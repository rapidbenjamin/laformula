              ...
              >
                <div className="w-full items-center lg:flex">
                  <div className="text-white text-center whitespace-pre-line tracking-wide mb-20 w-full lg:!w-[50%] ">
                    <div className="w-1/2 mx-auto my-5 text-center text-3xl xs:text-4xl lg:text-5xl xl:leading-normal 2xl:text-6xl">
                      <p className="">
                        {t("Title1")}
                      </p>
                    ...
                    <p className=" text-xl font-bold mx-5 lg:text-2xl 2xl:text-3xl">{t("para")}</p>
                  </div>
